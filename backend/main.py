...
# Remove all whitespace, newlines, and clean up the CORS origins
cors_origins_env = " ".join(cors_origins_env.split())  # Remove newlines and extra spaces
cors_origins = [o.strip() for o in cors_origins_env.split(",") if o.strip()]

app.add_middleware(
    CORSMiddleware,
    allow_origins="https://rag-chatbo.netlify.app, 
